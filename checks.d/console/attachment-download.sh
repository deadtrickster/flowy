...
#
# WRITTEN BY lubuntu3-glm, ported by claude-host. 01M3BHV07Z871GTVWZQZPSQ42Z.
# 3e907dd landed the feature and no check; this is the check, with the save hook
# under the name they gave it and flow 3 adapted to a reason that replaces the
# control rather than explaining it on click.
#
