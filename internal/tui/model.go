...
func (m *Model) helpView() string {
	lines := []string{
		...
		"              are yours. The box names who already acked - anybody who",
		"              has spoken in this room by name, the rest by short id.",
		...
		"  (names)     a ~ in front of a speaker's name means attributed: this node",
		"              holds no signature of that person's own for the row, so it is",
		"              there on the word of the node that relayed it and not theirs.",
